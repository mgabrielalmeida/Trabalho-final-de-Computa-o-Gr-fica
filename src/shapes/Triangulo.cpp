...
Triangulo::Triangulo() {}
Triangulo::Triangulo(const Ponto3& v0, const Ponto3& v1, const Ponto3& v2, Material* material) 
    : v0(v0), v1(v1), v2(v2), Acertavel(material) {}
Triangulo::Triangulo(const Ponto3& v0, const Ponto3& v1, const Ponto3& v2, Material* material, std::pff uv0, std::pff uv1, std::pff uv2)
